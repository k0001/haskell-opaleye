...
connectInfo =  PGS.ConnectInfo { PGS.connectHost = "localhost"
                               ...
                               , PGS.connectUser = "opaleye_test"
                               , PGS.connectPassword = "opaleye_test"
...
twoIntTable n = O.Table "public" n (PP.p2 (O.required "column1", O.required "column2"))
...
table5 = O.Table "public" "table5" (PP.p2 (O.optional "column1", O.optional "column2"))

table6 :: O.Table (Column O.PGText, Column O.PGText) (Column O.PGText, Column O.PGText)
table6 = O.Table "public" "table6" (PP.p2 (O.required "column1", O.required "column2"))

tableKeywordColNames :: O.Table (Column O.PGInt4, Column O.PGInt4)
                                (Column O.PGInt4, Column O.PGInt4)
tableKeywordColNames = O.Table "public" "keywordtable" (PP.p2 (O.required "column", O.required "where"))
